...
1. User-friendly operation - you shouldn't need to be intimately familiar with linux to make use of this stuff, ideally. Stuff should be relatively fault-tolerant and reliable.
